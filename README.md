...
<details>
<summary style="cursor: pointer;"><b>💡 한줄 소개: 사용자 취향 분석 기반 만화 추천 및 커뮤니티 AI SaaS</b></summary>

<!-- 프로젝트 타이틀 및 소개 -->
<div align="center">
  <h1>🚀 만화당 (ComicTrend)</h1>
  <p><b>AI 기반 만화 트렌드 분석 및 초개인화 추천 서비스</b></p>
  <p>분산된 만화 커뮤니티의 반응을 통합하고, AI로 여론·트렌드를 요약해 한눈에 보여줍니다.</p>
</div>
